...
const selectedPrimaryColor = ref('blue')
...
const updateColors = (colorName) => {
        ...
        if (!document.startViewTransition) {
            applyTheme('primary', selectedColor.palette);

            return;
        }

        document.startViewTransition(() => applyTheme('primary', selectedColor.palette));
    }
...
updateColors(selectedPrimaryColor.value)
</script>
